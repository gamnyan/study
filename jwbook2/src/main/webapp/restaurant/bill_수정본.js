function menuClick(event) {
    ...
    td.appendTo(tr);
    td = $('<td>');
    input = $('<input>', {type: 'hidden', class: 'menu_id', name: 'menuId', value: menu.data().menuId});
    input.appendTo(td);
    input = $('<input>', {type: 'number', class: 'menu_quantity', name: 'menuQuantity', value: 1, step: 1, min: 1});
    input.appendTo(td);
    td.appendTo(tr);
    td = $('<td>');
