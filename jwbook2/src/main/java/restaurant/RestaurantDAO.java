...
public class RestaurantDAO {
	...
	final static String QUERY_PATH = "/restaurant/restaurant_queries.properties";
	...
	public List<Customer> getCustomers() {
		...
		try (Connection c = dataSource.getConnection()) {
			...
			rtn = qr.query(c, QM.get("getCustomers"), h);
	...
	public Map<Long, Customer> getCustomersByIds(String ids) {
		Map<Long, Customer> rtn = new HashMap<>();

		try (Connection c = dataSource.getConnection();) {
			QueryRunner qr = new QueryRunner();
			ResultSetHandler<Map<Long, Customer>> h = new BeanMapHandler<>(Customer.class, "id");
			rtn = qr.query(c, QM.get("getCustomersByIds").replace(":ids:", ids), h);
		} catch (SQLException sqle) {
			sqle.printStackTrace();
		}
	...
	public void addBill(Bill bill) {
		try (Connection c = dataSource.getConnection();) {
			...
			try {
				...
				Object[] p = {};
				p = new Object[] { bill.getDiscountPrice(), bill.getPrice(), new java.util.Date(),
